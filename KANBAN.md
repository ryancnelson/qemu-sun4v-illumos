...
| In progress | P0 | Biggie | Trial `term4code-02` | Boot the bounded-I/O A/B artifact, prove storage/channel/PPP, install persistently, and cold reboot | Immutable release `oi-bounded-v2-20260826`, fresh units101/104, exact argv, and real-evidence pipeline reached `PRELAUNCH_READY`; overnight execution is authorized |
