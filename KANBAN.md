...
| Blocked | P0 | Biggie | Preparation `term4code-02` | Build the bounded-I/O A/B artifact and stop at Ryan prelaunch signoff | Pipeline and fixture tests pass; fresh units101/104 pass; current config exits 20 `BLOCKED_MISSING_BUILDER_TOPOLOGY`; supply reviewed disposable donor unit/slice manifest, then require reopened archive manifest and `PRELAUNCH_READY` without booting the trial |
